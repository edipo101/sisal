...
<div class="row">
	<div class="col-md-3">
		<div class="box">
			<div class="box-body">
				<img src="{{ asset('img/empresa/'.$empresa->logo) }}" alt="{{ str_slug($empresa->sigla) }}" class="img-responsive img-thumbnail center-block">
				<h4 class="text-center">{{ $empresa->nombre }}</h4>
				<p class="text-muted text-center">{{ $empresa->email }}</p>
			</div>
			<!-- /.box-body -->
			<div class="box-footer">
				<button type="button" id='upload' class="btn bg-black btn-sm btn-block"><i class="fa fa-picture-o"></i> SUBIR FOTO</button>
			</div>
		</div>
	</div>
	<div class="col-md-9">
